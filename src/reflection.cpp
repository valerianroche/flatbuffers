    ...
    case reflection::Obj:
      if (schema) {
        ...
        if (objectdef.is_struct()) {
          ...
          s += " { ";
          const Vector<Offset<reflection::Field> > * fielddefs = objectdef.fields();
...
class ResizeContext {
 public:
  ResizeContext(const reflection::Schema &schema, uoffset_t start, int delta,
    ...
    int mask = static_cast<int>(sizeof(largest_scalar_t) - 1);
  ...
  uint8_t &DagCheck(void *offsetloc) {
    ptrdiff_t dag_idx = reinterpret_cast<uoffset_t *>(offsetloc) -
...
void SetString(const reflection::Schema &schema, const std::string &val,
  ...
  int delta = static_cast<int>(val.size()) - static_cast<int>(str->Length());
...
uint8_t *ResizeAnyVector(const reflection::Schema &schema, uoffset_t newsize,
                         ...
                         const reflection::Object *root_table) {
  int delta_elem = static_cast<int>(newsize) - static_cast<int>(num_elems);
  int delta_bytes = delta_elem * static_cast<int>(elem_size);
  ptrdiff_t vec_start = reinterpret_cast<const uint8_t *>(vec) - flatbuf->data();
  ...
  if (delta_bytes) {
    if (delta_elem < 0) {
      ...
      // buffer.
      int size_clear = -delta_elem * elem_size;
